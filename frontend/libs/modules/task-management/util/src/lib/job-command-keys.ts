...
export const TASK_MANAGEMENT_JOB_COMMAND_KEYS = {
  ...
  setProjectWorkflowScheme: 'shared.jobs.commands.taskmgmtProjectSetWorkflowScheme',
  addProjectMember: 'shared.jobs.commands.taskmgmtProjectAddMember',
  removeProjectMember: 'shared.jobs.commands.taskmgmtProjectRemoveMember',
  setBoardCardPosition: 'shared.jobs.commands.taskmgmtBoardSetCardPosition',
  createBoard: 'shared.jobs.commands.taskmgmtBoardCreate',
  setBoardName: 'shared.jobs.commands.taskmgmtBoardSetName',
  setBoardColumns: 'shared.jobs.commands.taskmgmtBoardSetColumns',
