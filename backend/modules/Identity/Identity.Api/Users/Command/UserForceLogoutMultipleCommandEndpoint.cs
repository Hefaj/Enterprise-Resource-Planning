...
/// </summary>
public sealed class UserForceLogoutMultipleCommandEndpoint
    : BatchEndpointBase<UserForceLogoutCommand, SearchUserAccountRequest>
{
    private readonly IUserAccountQueries _queries;
    private readonly UserBatchValidator _validator;

    public UserForceLogoutMultipleCommandEndpoint(IUserAccountQueries queries, UserBatchValidator validator)
    {
        _queries = queries;
    ...
    protected override Task<ValidationTracker> ValidateTargetsAsync(
        IReadOnlyList<BatchTarget<UserForceLogoutCommand>> targets,
        CancellationToken ct)
