...
import { UserAddRoleMetadata } from './user-add-role.definition';
 ...
 * `ErpBatchStepBase`. */
@Component({
  selector: 'erp-identity-user-add-role-step',
  standalone: true,
  imports: [ErpStepContentComponent],
  template: `<erp-step-content [contentConfig]="formContent" />`,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UserAddRoleStepComponent extends ErpBatchStepBase<BatchCommandOfUserAddRoleCommandAndSearchUserAccountRequest, UserAddRoleMetadata> {
      ...
      b
        ...
        .addBatchTargetsSummary((s) =>
          s
            ...
            .setMessages({
              messageKey: USERS_KEYS.commands.addRole.editMessage,
              suffixSingleKey: USERS_KEYS.commands.addRole.userSuffixSingle,
              suffixPluralKey: USERS_KEYS.commands.addRole.userSuffixPlural,
              filterModeSuffixKey: USERS_KEYS.commands.addRole.filterModeSuffix,
              filterModeHintKey: USERS_KEYS.commands.addRole.filterModeHint,
            }),
        )
        .addFormField('roleUuid', 'inputPicker', (f) => f.setLabel(USERS_KEYS.commands.addRole.roleLabel).setItems(roles).setLabelKey('name').setValueKey('uuid').setStrategy('single'), {
        ...
        .addFormField('expiresAt', 'text', (f) => f.setLabel(USERS_KEYS.commands.addRole.expiresAtLabel).setPlaceholder(USERS_KEYS.commands.addRole.expiresAtPlaceholder), {
