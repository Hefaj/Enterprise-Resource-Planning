...
Codzienne uruchamianie środowiska — zależności Docker, mikroserwisy i frontend
w trybie monolitu — opisuje [development.md](./development.md).

## Frontend — Angular NX, Native Federation

| Temat                                                                                           | Plik                                                                      |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Uruchomienie środowiska lokalnego — Docker, API, frontend jako monolit, MFE tylko do integracji | [development.md](./development.md)                                        |
