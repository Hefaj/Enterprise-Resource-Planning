...
| Operacja produkująca plik (eksport, raport, dokument) — agregat przebiegu, `job.kind`, MinIO, `IArtifactStore`, wygasanie | [`docs/backend/exports-artifacts.md`](docs/backend/exports-artifacts.md) |
