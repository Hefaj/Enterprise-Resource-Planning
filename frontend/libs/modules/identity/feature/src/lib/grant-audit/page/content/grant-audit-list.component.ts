...
import { IdentityGrantAuditTableComponent } from '../../components/tables/identity-grant-audit-table/identity-grant-audit-table.component';
...
export class GrantAuditListComponent {
