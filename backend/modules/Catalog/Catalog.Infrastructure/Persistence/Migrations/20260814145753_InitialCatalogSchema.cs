    ...
    public partial class InitialCatalogSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_category", x => new { x.product_uuid, x.category_uuid });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_multimedia", x => new { x.product_uuid, x.multimedia_uuid });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_product_warranty", x => new { x.product_uuid, x.warranty_uuid });
                    table.ForeignKey(
