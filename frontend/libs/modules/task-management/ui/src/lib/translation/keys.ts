...
export const TASKMANAGEMENT_KEYS = {
    navigation: {
      module: 'taskManagement.navigation.module',
      issues: 'taskManagement.navigation.issues',
      requests: 'taskManagement.navigation.requests',
      projects: 'taskManagement.navigation.projects',
      boards: 'taskManagement.navigation.boards',
      backlog: 'taskManagement.navigation.backlog',
      reports: 'taskManagement.navigation.reports',
      configuration: 'taskManagement.navigation.configuration',
    },
    workflow: {
      states: {
