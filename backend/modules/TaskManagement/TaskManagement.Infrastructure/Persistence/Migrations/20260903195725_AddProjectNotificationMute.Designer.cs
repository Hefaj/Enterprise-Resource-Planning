...
namespace TaskManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903195725_AddProjectNotificationMute")]
    partial class AddProjectNotificationMute
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.Webhooks.Webhook", b =>
                {
                    b.Property<Guid>("Uuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<List<string>>("_eventKinds")
                        .IsRequired()
                        .HasColumnType("text[]")
                    ...
                    b.HasIndex("ProjectUuid", "IsEnabled")
                        .HasDatabaseName("ix_webhook_project_uuid_is_enabled");

                    b.ToTable("webhook", "taskmgmt");
                });

            modelBuilder.Entity("TaskManagement.Domain.Webhooks.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Uuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("WebhookUuid")
                        .HasColumnType("uuid")
                        .HasColumnName("webhook_uuid");
                    ...
                    b.HasIndex("Status", "NextAttemptAt")
                        .HasDatabaseName("ix_webhook_delivery_status_next_attempt_at");

                    b.HasIndex("WebhookUuid", "CreatedAt")
                        .HasDatabaseName("ix_webhook_delivery_webhook_uuid_created_at");

                    b.ToTable("webhook_delivery", "taskmgmt");
                });
