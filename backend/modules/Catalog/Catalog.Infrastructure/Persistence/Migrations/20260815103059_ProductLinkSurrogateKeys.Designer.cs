...
namespace Catalog.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260815103059_ProductLinkSurrogateKeys")]
    partial class ProductLinkSurrogateKeys
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Catalog.Domain.Products.ProductCategoryLink", "_categories", b1 =>
                        {
                            ...
                            b1.HasIndex("ProductUuid", "CategoryUuid")
                                .IsUnique()
                    ...
                    b.OwnsMany("Catalog.Domain.Products.ProductMultimediaLink", "_multimedia", b1 =>
                        {
                            ...
                            b1.HasIndex("ProductUuid", "MultimediaUuid")
                                .IsUnique()
                    ...
                    b.OwnsMany("Catalog.Domain.Products.ProductWarranty", "_warranties", b1 =>
                        {
                            ...
                            b1.HasIndex("ProductUuid", "WarrantyUuid")
                                .IsUnique()
